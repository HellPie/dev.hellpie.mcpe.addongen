...
import dev.hellpie.mcpe.addongen.ui.data.WizardData;
...
//}
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mSetupData = (WizardData) getLastNonConfigurationInstance();
        if (mSetupData == null) {
    ...
    private void finalizeSetup() {
        mFinishRunnables.add(new Runnable() {
            ...
            public void run() {
                ...
                SetupWizardUtils.disableGMSSetupWizard(MainActivity.this);
                final WallpaperManager wallpaperManager =
                        WallpaperManager.getInstance(MainActivity.this);
                wallpaperManager.forgetLoadedWallpaper();
            }
    ...
    private static class FinishTask extends AsyncTask<Void, Void, Boolean> {
        ...
        public FinishTask(MainActivity activity,
